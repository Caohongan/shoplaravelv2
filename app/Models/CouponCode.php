...
class CouponCode extends Model
{
    ...
    public function getDescriptionAttribute()
    {
        ...
        return $str.'Less'.str_replace('.00', '', $this->value);
    }
    ...
    public function checkAvailable(User $user, $orderAmount = null)
    {
        ...
        if ($this->not_before && $this->not_before->gt(Carbon::now())) {
            throw new CouponCodeUnavailableException('The coupon is not yet available');
        }
        ...
        if (!is_null($orderAmount) && $orderAmount < $this->min_amount) {
            throw new CouponCodeUnavailableException('Order amount does not meet the minimum amount of the coupon');
        }
