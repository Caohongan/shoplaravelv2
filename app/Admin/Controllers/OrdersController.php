...
class OrdersController extends Controller
{
    ...
    public function edit(Order $order, Content $content)
    {
        return $content
            ->header('Edit order')
    ...
    protected function grid()
    {
        ...
        $grid->filter(function($filter){
            ...
            $filter->expand();
            // Add a column filter
            $filter->like('no', 'Mã order sản phẩm');
    ...
    public function ship(Order $order, Request $request)
    {
        // 判断当前订单是否已支付
        if (!$order->paid_at) {
            throw new InvalidRequestException('The order is outstanding');
        }
        // 判断当前订单发货状态是否为未发货
    ...
    protected function _refundOrder(Order $order)
    {
        ...
        switch ($order->payment_method) {
            ...
            default:
                ...
                throw new InternalException('Payment method for unknown order:'.$order->payment_method);
                break;
        }
    }
}
